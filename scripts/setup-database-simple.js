 ...
 * Creates essential warehouse tables
 */
...
if (supabaseUrl === 'YOUR_SUPABASE_URL' || supabaseServiceKey === 'YOUR_SERVICE_KEY') {
  ...
  console.log('\n🔧 Quick Fix: Replace the placeholder values in this script with your actual credentials');
  console.log('   Line 9: const supabaseUrl = "https://your-project.supabase.co";');
  console.log('   Line 10: const supabaseServiceKey = "your-service-role-key";');
  process.exit(1);
}
