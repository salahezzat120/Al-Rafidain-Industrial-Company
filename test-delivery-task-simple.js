...
async function testDeliveryTaskCreation() {
  ...
  try {
    ...
    // Test 2: Create a simple delivery task
    console.log('\n2. Creating delivery task...');
    ...
    // Test 3: Create task items
    console.log('\n3. Creating task items...');
    ...
    // Test 4: Fetch the complete task
    console.log('\n4. Fetching complete task...');
