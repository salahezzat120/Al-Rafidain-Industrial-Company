-- =====================================================
-- FIX VISIT MANAGEMENT TABLES
-- This script fixes any issues with the visit management tables
-- =====================================================

-- First, let's check if tables exist and drop them if they have issues
...
DO $$
BEGIN
    RAISE NOTICE 'Visit Management System tables fixed and recreated successfully!';
    RAISE NOTICE 'All tables now have the correct structure with sender_id columns';
